...
CREATE TABLE [dbo].[Review] (
    ...
    CONSTRAINT [Review_product_id_user_id_key] UNIQUE NONCLUSTERED ([product_id],[user_id])
);
...
-- CreateIndex
CREATE NONCLUSTERED INDEX [Product_is_active_idx] ON [dbo].[Product]([is_active]);
...
-- CreateIndex
CREATE NONCLUSTERED INDEX [Review_product_id_idx] ON [dbo].[Review]([product_id]);

-- CreateIndex
CREATE NONCLUSTERED INDEX [Review_user_id_idx] ON [dbo].[Review]([user_id]);
...
-- AddForeignKey
ALTER TABLE [dbo].[Review] ADD CONSTRAINT [Review_product_id_fkey] FOREIGN KEY ([product_id]) REFERENCES [dbo].[Product]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[Review] ADD CONSTRAINT [Review_user_id_fkey] FOREIGN KEY ([user_id]) REFERENCES [dbo].[User]([id]) ON DELETE CASCADE ON UPDATE CASCADE;
